...
export type CreateExerciseInitialStatsInput =
  CreateDto<ExerciseInitialStatsProps>;
export type CreateExerciseInitialStatsWithoutExerciseIdInput =
  Omit<CreateDto<ExerciseInitialStatsProps>, 'exerciseId'>;
