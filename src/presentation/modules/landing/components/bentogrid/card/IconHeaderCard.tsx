...
export function IconHeaderCard({
  ...
  return (
    <BentoCard
      className={`p-2 md:row-span-3 md:p-0 ${className}`}
    >
      <main className="flex h-full flex-col gap-2 overflow-hidden p-4">
        ...
        <main className="text-center">
          <header className="font-funnel-display fg-strong text-xl font-bold">
            {title}
          </header>
          <p className="fg-default text-base leading-[1.3] md:text-lg">
            {description}
          </p>
        </main>
      </main>
