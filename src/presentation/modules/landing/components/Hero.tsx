...
function Highilight({ children }: { children: React.ReactNode }) {
  return (
    <span className="from-accent to-tertiary light:from-0% light:to-80% light:to-primary bg-linear-to-b from-50% to-100% bg-clip-text text-transparent">
      {children}
    </span>
  );
}
