...
type Props<Schema extends ZodSchema<any, any>, FormValues> = {
  children: React.ReactNode;
  flatSteps: FlatStep[];
  flatStepsWithText: FlatStepWithText[];
  formSchema: Schema;
  formDefaultValues: Record<string, FormValues>;
  processSetFormData: (data: FormValues) => Promise<ActionResponseProps<FormValues>>;
...
export function WizardProvider<Schema extends ZodSchema<any, any>, FormValues>({
  children,
  flatSteps,
  flatStepsWithText,
  formSchema,
